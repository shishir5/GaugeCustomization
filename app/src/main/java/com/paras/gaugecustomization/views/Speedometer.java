...
import com.paras.gaugecustomization.indicators.Indicator;
import com.paras.gaugecustomization.indicators.NoIndicator;
import com.paras.gaugecustomization.interfaces.OnPrintTickLabel;
import com.paras.gaugecustomization.note.Note;
...
public abstract class Speedometer extends Gauge {
    ...
    private int markColor = Color.WHITE, lowSpeedColor = Color.GREEN, mediumSpeedColor = Color.YELLOW, highSpeedColor = Color.RED, backgroundCircleColor = Color.WHITE;
     ...
     */
    public float getSpeedAtDegree(float degree) {
     ...
     * this option will ignore when using {@link com.paras.gaugecustomization.indicators.ImageIndicator}.
     *
